...
# --- 2. CONFIGURAÇÕES DE IDENTIDADE E INTERFACE ---
st.set_page_config(page_title="Amoria", page_icon="🤖", layout="wide")

# Recupera as chaves do arquivo .env
TEXT_API_KEY = os.getenv("TEXT_API_KEY")
IMAGE_API_KEY = os.getenv("IMAGE_API_KEY")

# Alerta de segurança caso as chaves não estejam configuradas
if not TEXT_API_KEY or not IMAGE_API_KEY:
    st.error("⚠️ As chaves de API não foram encontradas! Verifique se o seu arquivo `.env` contém `TEXT_API_KEY` e `IMAGE_API_KEY`.")
    st.stop()
...
# --- 3. NOVA FUNÇÃO DE BUSCA (WIKIPEDIA + YAHOO SEARCH) ---
...
# --- 5. IDENTIDADE PURA (SEM REGRAS QUE POSSAM VAZAR) ---
